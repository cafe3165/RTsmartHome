...
//		将找到的底层设备实例化为运行时空调
		...
		if (f) {
			System.out.println("DId: " + swp.getId());
			System.out.println("DName: " + swp.getDName());
			System.out.println("Type: " + swp.getType());
			System.out.println("LName: " + swp.getLName());
			System.out.println("Status: " + swp.getStatus());
			System.out.println("Value2: " + swp.getHumidity());
		}
