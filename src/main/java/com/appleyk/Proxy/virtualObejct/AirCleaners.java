...
//		将找到的底层设备实例化为运行时空调
		...
		AirCleaner ac = (AirCleaner) runtimeDevice;

		if (f) {
			System.out.println("DId: " + ac.getId());
			System.out.println("DName: " + ac.getDName());
			System.out.println("Type: " + ac.getType());
			System.out.println("LName: " + ac.getLName());
			System.out.println("Status: " + ac.getStatus());
			System.out.println("Value: " + ac.getPM2_5());
		}
