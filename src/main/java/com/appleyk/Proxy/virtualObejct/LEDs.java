...
//		将找到的底层设备实例化为运行时空调
		...
		SmartLed led = (SmartLed) runtimeDevice;

		if (f) {
			System.out.println("DId: " + led.getId());
			System.out.println("DName: " + led.getDName());
			System.out.println("Type: " + led.getType());
			System.out.println("LName: " + led.getLName());
			System.out.println("Status: " + led.getStatus());
			System.out.println("Value: " + led.getBrightness());
		}
